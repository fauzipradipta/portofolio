        ...
        <div className="text-left">
          ...
          {skillsData.technical.map((techCategory) => (
            <div
              ...
              className="mb-2 py-2 px-3 border border-gray-200 rounded-lg shadow-sm card-skill dark:border-gray-700"
            >
            ...
            <div className="flex flex-col items-center gap-5">
              {skillsData.soft.map((skill, index) => (
                <div key={index} className="flex items-center gap-4 w-full">
                  ...
                  <span className="text-body font-medium text-center flex-1 gap-8">{skill}</span>
                </div>
              ))}
            </div>
          </div>
