        ...
        <div className="flex justify-center">
          <div className="max-w-4xl mx-auto text-center w-full px-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              <a href={personalInfo.linkedin} target="_blank" rel="noopener noreferrer" className="btn-primary flex items-center justify-center space-x-2 w-full sm:w-auto px-6 py-3"><Linkedin size={16} /><span>LINKEDIN</span></a>
              <a href={`mailto:${personalInfo.email}`} className="btn-accent flex items-center justify-center space-x-2 w-full sm:w-auto px-6 py-3"><Mail size={16} /><span>GET IN TOUCH</span></a>
            </div>
            <div className="flex justify-center">
              <ReadMoreButton />
            </div>
