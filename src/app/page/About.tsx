      ...
      <div className="container">
        <div className="grid-container">
          <div className="text-center mb-16">
            ...
            <div className="about-bio sm:text-base md:text-lg w-full max-w-xs sm:max-w-md md:max-w-2xl mx-auto leading-relaxed break-words whitespace-normal text-justify sm:text-center">
